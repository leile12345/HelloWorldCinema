...
public class HibernateUtil_CompositeQuery_Mem3 {
	  public static Predicate get_aPredicate_For_AnyDB(CriteriaBuilder builder, Root<Mem> root, String columnName, String value) {
	        Predicate predicate = null;

	        // 根據欄位類型建立 Predicate
	        if ("memId".equals(columnName)) {
	            predicate = builder.equal(root.get(columnName), Integer.valueOf(value));
	        } else if ("memName".equals(columnName) || "memEmail".equals(columnName) || "memMobile".equals(columnName) || "memStatus".equals(columnName)) {
